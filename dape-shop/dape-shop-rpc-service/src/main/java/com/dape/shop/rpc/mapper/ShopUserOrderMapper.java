...
public interface ShopUserOrderMapper {
    ...
    public List<ShopOrder> selectTuiGuangOrder(@Param("start") Integer start, @Param("limit") Integer limit, @Param("shopUser") ShopUser shopUser);
    public int getUserMoney(@Param("shopOrder") ShopOrder shopOrder);
}
