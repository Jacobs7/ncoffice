package com.dape.upms.server.controller;
...
public class SSOController extends BaseController {
    ...
    public String login(HttpServletRequest request) {
        ...
        // 判断是否已登录，如果已登录，则回跳
        String code = RedisUtil.get(DAPE_UPMS_SERVER_SESSION_ID + "_" + serverSessionId);
        // code校验值
    ...
    public Object code(HttpServletRequest request) {
        ...
        String code = RedisUtil.get(DAPE_UPMS_SERVER_CODE + "_" + codeParam);
