...
<head>
	...
	<link href="${basePath}/resources/dape-lte/plugins/bootstrap-3.3.0/css/bootstrap.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/dape-lte/plugins/material-design-iconic-font-2.2.0/css/material-design-iconic-font.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/dape-lte/plugins/waves-0.7.5/waves.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/dape-lte/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.min.css" rel="stylesheet"/>
	<link href="${basePath}/resources/dape-lte/css/admin.css" rel="stylesheet"/>
	<style>
		/** skins **/
	...
	<ul id="menu">
		...
		<li id="logo" class="hidden-xs">
			<a href="${basePath}/manage/index">
				<img src="${basePath}/resources/dape-lte/images/logo.png"/>
			</a>
...
<section id="main">
	...
	<aside id="sidebar">
		...
		<ul class="main-menu">
			...
			<li>
				<div class="upms-version">&copy; DP-UPMS V1.0.0</div>
			</li>
		</ul>
		<!-- /菜单区 -->
	</aside>
	...
	<section id="content">
		...
		<div class="content_main">
			<div id="iframe_home" class="iframe cur">
				...
				<p><h4>关于作者</h4></p>
				<p><b>姓　　名</b>：DP-OFFICE</p>
				<p><b>电子邮箱</b>：23484376@qq.com</p>
			</div>
		</div>
	</section>
</section>
...
<script src="${basePath}/resources/dape-lte/plugins/jquery.1.12.4.min.js"></script>
<script src="${basePath}/resources/dape-lte/plugins/bootstrap-3.3.0/js/bootstrap.min.js"></script>
<script src="${basePath}/resources/dape-lte/plugins/waves-0.7.5/waves.min.js"></script>
<script src="${basePath}/resources/dape-lte/plugins/malihu-custom-scrollbar-plugin/jquery.mCustomScrollbar.concat.min.js"></script>
<script src="${basePath}/resources/dape-lte/plugins/BootstrapMenu.min.js"></script>
<script src="${basePath}/resources/dape-lte/plugins/device.min.js"></script>
<script src="${basePath}/resources/dape-lte/plugins/jquery.cookie.js"></script>
<script src="${basePath}/resources/dape-lte/js/admin.js"></script>
<script src="${basePath}/resources/dape-lte/plugins/fullPage/jquery.fullPage.min.js"></script>
<script src="${basePath}/resources/dape-lte/plugins/fullPage/jquery.jdirk.min.js"></script>
</body>
</html>